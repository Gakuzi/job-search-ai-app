...
// This is a new icon required by the design of JobCard.
...
const JobCard: React.FC<JobCardProps> = ({ job, onSave, onDismiss }) => {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col">
            <div className="p-5 flex-grow">
                ...
                <a href={job.url} target="_blank" rel="noopener noreferrer" className="text-sm text-primary-500 hover:underline mt-2 inline-block">
                    Подробнее на hh.ru
                </a>
            </div>
