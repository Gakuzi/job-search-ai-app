...
import { CodeBracketIcon } from '@components/icons/CodeBracketIcon.tsx';
                ...
                {activeTab === 'vercel' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <Step number={3} title="Переразверните приложение">
                            После сохранения всех переменных Vercel должен автоматически запустить новое развертывание (deployment). Если нет, запустите его вручную.
                        </Step>
                    </div>
                )}
